export const translations = {
  de: {
    ...
    sectionForceTooltip: 'Windkraft auf den zugeordneten Mastabschnitt — nur zur Anzeige. Die Drahtspannung wird aus dem Kippmoment berechnet (Abschnitt + Antennenmoment bei der obersten Ebene), nicht direkt aus dieser Kraft.',
  ...
  en: {
    ...
    sectionForceTooltip: 'Wind force on the assigned mast section — display only. Wire tension is calculated from the overturning moment (section + antenna moment at the top level), not directly from this force.',
